  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          {isSignup && (
            <div style={styles.rgpdRow}>
              ...
              />
              <label htmlFor="rgpd" style={styles.rgpdLabel}>
                J'accepte la{' '}
                <span style={styles.rgpdLink} onClick={e => { e.preventDefault(); setShowRGPD(true) }}>
        ...
        <div style={styles.rgpdFooter}>
          <span style={styles.rgpdFooterLink} onClick={() => setShowRGPD(true)}>
...
const styles = {
  ...
  btn:           { padding: '12px', background: '#0C447C', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '14px', fontWeight: '700', marginTop: '4px' },
  ...
  rgpdRow:       { display: 'flex', alignItems: 'flex-start', gap: '10px' },
  rgpdLabel:     { fontSize: '12px', color: '#4A6080', lineHeight: 1.6, cursor: 'pointer' },
  rgpdLink:      { color: '#185FA5', textDecoration: 'underline', cursor: 'pointer' },
  rgpdFooter:    { textAlign: 'center', marginTop: '16px' },
  rgpdFooterLink:{ fontSize: '11px', color: '#B0BBCC', cursor: 'pointer', textDecoration: 'underline' },
}